...
#' 
#' @param arriveBy Optional. Defaults to false, i.e. one to many search
#' 
#' true = many to one
#' false = one to many
...
#' @param preTransitModes Optional. Default is `WALK`. Does not apply to direct connections (see `directMode`).
#' 
...
#'
#' Allowed values: WALK, BIKE, RENTAL, CAR, CAR_PARKING, CAR_DROPOFF, ODM, RIDE_SHARING, FLEX, DEBUG_BUS_ROUTE, DEBUG_RAILWAY_ROUTE, DEBUG_FERRY_ROUTE, TRANSIT, TRAM, SUBWAY, FERRY, AIRPLANE, BUS, COACH, RAIL, HIGHSPEED_RAIL, LONG_DISTANCE, NIGHT_RAIL, REGIONAL_FAST_RAIL, REGIONAL_RAIL, SUBURBAN, FUNICULAR, AERIAL_LIFT, OTHER, AREAL_LIFT, METRO, CABLE_CAR.
#' @param postTransitModes Optional. Default is `WALK`. Does not apply to direct connections (see `directMode`).
#' 
...
#'
#' Allowed values: WALK, BIKE, RENTAL, CAR, CAR_PARKING, CAR_DROPOFF, ODM, RIDE_SHARING, FLEX, DEBUG_BUS_ROUTE, DEBUG_RAILWAY_ROUTE, DEBUG_FERRY_ROUTE, TRANSIT, TRAM, SUBWAY, FERRY, AIRPLANE, BUS, COACH, RAIL, HIGHSPEED_RAIL, LONG_DISTANCE, NIGHT_RAIL, REGIONAL_FAST_RAIL, REGIONAL_RAIL, SUBURBAN, FUNICULAR, AERIAL_LIFT, OTHER, AREAL_LIFT, METRO, CABLE_CAR.
#' @param directMode Default is `WALK` which will compute walking routes as direct connections.
#' 
...
mc_oneToManyIntermodal <- function(one = NULL, many = NULL, time = NULL, maxTravelTime = NULL, maxMatchingDistance = NULL, arriveBy = NULL, maxTransfers = NULL, minTransferTime = NULL, additionalTransferTime = NULL, transferTimeFactor = NULL, useRoutedTransfers = NULL, pedestrianProfile = NULL, pedestrianSpeed = NULL, cyclingSpeed = NULL, elevationCosts = NULL, transitModes = NULL, preTransitModes = NULL, postTransitModes = NULL, directMode = NULL, maxPreTransitTime = NULL, maxPostTransitTime = NULL, maxDirectTime = NULL, requireBikeTransport = NULL, requireCarTransport = NULL, .return_as = NULL, .json_parser = NULL, .headers = NULL, .auth = NULL, .throttle_rate = NULL, .build_only = NULL, .server = NULL, .endpoint = NULL, .referer = NULL, .req_options = NULL, .handle_response = NULL, .json_auto_unbox = NULL, .paginate = NULL) {
  ...
  if (!is.null(directMode)) query_params[['directMode']] <- directMode
