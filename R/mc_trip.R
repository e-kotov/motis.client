...
#' @export
mc_trip <- function(tripId = NULL, withScheduledSkippedStops = NULL, joinInterlinedLegs = NULL, language = NULL, .return_as = NULL, .json_parser = NULL, .headers = NULL, .auth = NULL, .throttle_rate = NULL, .build_only = NULL, .server = NULL, .endpoint = NULL, .referer = NULL, .req_options = NULL, .handle_response = NULL, .json_auto_unbox = NULL, .paginate = NULL) {
  ...
  # Path parameters
  path_params <- list()
  path_template <- .endpoint %||% "/api/v5/trip"
  ...
  # Query parameters
  query_params <- list()
  if (!is.null(tripId)) query_params[['tripId']] <- tripId
